"""Creation the character and assigning properties to it."""
from random import randint
from graphic_arts.start_game_banner import run_screensaver


def attack(char_name: str, char_class: str) -> str:
    """Return the size of damage to the opponent.

    Note: Depending on class of character.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Return the size of blocked damage from the damage of opponent.
    ...
    return (f'{char_name} не заблокировал урона')


def special(char_name: str, char_class: str) -> str:
    """Return special feature depending on class of character."""
    if char_class == 'warrior':
